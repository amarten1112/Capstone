<?php
/**
 * customer/dashboard.php - Customer Dashboard (Placeholder)
 *
...
<div class="row">
    <div class="col-md-8 mx-auto">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <h5 class="card-title">Welcome, <?= htmlspecialchars($_SESSION['full_name'] ?? 'Customer', ENT_QUOTES, 'UTF-8') ?></h5>
                <p class="text-muted mb-3">You are logged in as <strong>Customer</strong>.</p>
        ...
        <!-- Placeholder links for future customer features -->
        <div class="row g-3">
            <div class="col-md-4">
